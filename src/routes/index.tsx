      ...
      <section className="relative overflow-hidden bg-ink">
        ...
        <div className="container-page relative flex min-h-[78vh] flex-col justify-center py-32 md:min-h-[88vh] md:py-48">
          <div className="max-w-2xl animate-fade-up">
            <p className="eyebrow mb-4 text-background/70">{heroEyebrow}</p>
            ...
            <p className="mt-6 max-w-xl text-lg text-background/80">{heroSubtitle}</p>
            {heroBadge && (
              <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-4 py-2 backdrop-blur-md">
                ...
                <span className="text-sm font-semibold text-background">{heroBadge}</span>
              </div>
            )}
